...
import com.zyw.horrarndoo.sdk.utils.SnackbarUtils;
...
public class ImageBrowseActivity extends BaseCompatActivity {
    ...
    private void saveImage(String fileName, File file){
        FileUtils.saveImage(ImageBrowseActivity.this, fileName, file, new FileUtils.SaveResultCallback() {
            @Override
            public void onSavedSuccess() {
                Snackbar.make(fabSavePic, "保存成功", Snackbar.LENGTH_SHORT)
                        .setActionTextColor(ResourcesUtils.getColor(R.color.white)).show();
            }

            @Override
            public void onSavedFailed() {
                Snackbar.make(fabSavePic, "保存失败", Snackbar.LENGTH_SHORT)
                        .setActionTextColor(ResourcesUtils.getColor(R.color.white)).show();
            }
        });
    }

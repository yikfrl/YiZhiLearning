package com.yz.yikfrl.yizhilearning.ui.widgets;
...
public class WebViewLongClickedPopWindow extends PopupWindow {
    ...
    private void initTab() {
        ...
        switch (mType){
            ...
            case IMAGE_VIEW_POPUPWINDOW://图片
                ...
                llPopupRoot = (LinearLayout)longClickedPopWindowView.findViewById(R.id.ll_popup_root);
    ...
    private void popupAnim(final View view, float start, float end, int duration, final boolean flag){
        final ValueAnimator va = ValueAnimator.ofFloat(start, end).setDuration(duration);

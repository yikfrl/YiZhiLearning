package com.yz.yikfrl.yizhilearning.presenter.home.tabs;
...
import com.yz.yikfrl.yizhilearning.global.MyApplication;
...
import com.yz.yikfrl.yizhilearning.model.home.tabs.WeixinChoiceModel;
...
public class WeixinPresenter extends WeixinContract.WeixinPresenter{
    ...
    public void loadLastestList() {
        mCurrentPage = 1;
        mRxManager.register(mIModel.getWeixinChoiceList(mCurrentPage, mPageStrip, mDttype, MyApplication.JU_HE_APP_KEY)
                .subscribe(new Consumer<WeixinChoiceListBean>() {
                    @Override

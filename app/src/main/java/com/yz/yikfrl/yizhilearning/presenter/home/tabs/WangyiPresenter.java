...
import com.yz.yikfrl.yizhilearning.model.home.tabs.WangyiModel;
...
public class WangyiPresenter extends WangyiContract.WangyiPresenter{
            ...
            public void accept(Throwable throwable) throws Exception {
                if(mIView != null){
                    if(mIView.isVisiable()){
                        mIView.showToast("Netword error.");
                    }
    ...
    public void onItemClick(final int position, WangyiNewsItemBean item) {
        ...
        bundle.putString(BundleKeyConstant.ARG_KEY_WANGYI_DETAIL_ID, item.getDigest());

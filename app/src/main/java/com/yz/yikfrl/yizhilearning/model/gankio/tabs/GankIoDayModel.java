package com.yz.yikfrl.yizhilearning.model.gankio.tabs;

import android.support.annotation.NonNull;

import com.yz.yikfrl.yizhilearning.api.GankioApi;
...
public class GankIoDayModel extends BaseModel implements GankIoDayContract.IGankIoDayModel {
    ...
    public Observable<List<GankIoDayItemBean>> getGankIoDayList(String year, String month, String day) {
        return RetrofitCreateHelper.createApi(GankioApi.class, GankioApi.HOST).getGankIoDay(year, month, day)
                .map(new Function<GankIoDayBean, List<GankIoDayItemBean>>() {
                    ...
                    public List<GankIoDayItemBean> apply(GankIoDayBean gankIoDayBean) throws Exception {
                        ...
                        itemAndroidBean.itemType = GankIoDayItemBean.GANK_IO_DAY_ITEM_DAY_REFRESH;
                        itemIOSBean.itemType = GankIoDayItemBean.GANK_IO_DAY_ITEM_DAY_REFRESH;
    ...
    public GankIoDayItemBean getGankIoDayAndroid(int page) {
        ...
        bean.itemType = GankIoDayItemBean.GANK_IO_DAY_ITEM_DAY_REFRESH;
        return bean;
    }
